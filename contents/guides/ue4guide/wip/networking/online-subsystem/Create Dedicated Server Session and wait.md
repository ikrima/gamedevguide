...
CreateCompleteDelegateHandle = Sessions-&gt;AddOnCreateSessionCompleteDelegate\_Handle(CreateCompleteDelegate);
...
SessionSettings-&gt;Set("password", DSS\_password, EOnlineDataAdvertisementType::ViaOnlineService);

SessionSettings-&gt;Set("lobbyName", DSS\_lobbyName, EOnlineDataAdvertisementType::ViaOnlineService);
...
SessionSettings-&gt;Set("versionNumber", DSS\_versionNumber, EOnlineDataAdvertisementType::ViaOnlineService);
